...
#ifndef ALIANALYSISTASKHFJETS_H
#define ALIANALYSISTASKHFJETS_H
...
class AliAnalysisTaskHFJets : public AliAnalysisTaskEmcalLight
{
public:
    ...
    public:
        ...
        Double_t LB1K1()     const { return fLB1K1               ; }
        Double_t LB15K1()    const { return fLB15K1               ; }
        Double_t LB2K1()     const { return fLB2K1               ; }
        Double_t LB3K1()     const { return fLB3K1               ; }
        Double_t R_std_default()    const { return fR_std_default               ; }
        Double_t R_WTA()    const { return fR_WTA               ; }
        Double_t R_SD()    const { return fR_SD               ; }
        Double_t R_STD_SD() const { return fR_STD_SD               ; }
        Double_t R_STD_WTA() const { return fR_STD_WTA               ; }
        Double_t R_WTA_SD() const { return fR_WTA_SD               ; }
    ...
    public:
        ...
        std::map<std::string, AliJetInfo> fJets     ; //!<! list of jets
        ...
        Double_t GetDistance(const AliJetInfo& jet, Double_t& deta, Double_t& dphi) const;
        Double_t GetDistance(const AliJetInfo& jet) const;
        Double_t Get_lambda_beta_kappa(const fastjet::PseudoJet &j, double beta, double kappa,double scaleR0, bool check_user_index) const;
        Double_t GetDistance_jet(const fastjet::PseudoJet &j, Double_t& deta, Double_t& dphi) const;
        Double_t GetDistance_jet(const fastjet::PseudoJet &j) const;
        void Print() const;
    ...
    public:
        ...
        Double32_t  fLB2K1      ;
        Double32_t  fLB3K1      ;
        Double32_t fR_std_default ;
        Double32_t fR_WTA ;
        Double32_t fR_SD ;
        Double32_t fR_STD_SD ;
        Double32_t fR_STD_WTA ;
    ...
    public:
        ...
        static std::pair<AliAnalysisTaskHFJets::EMesonOrigin_t, AliAODMCParticle*> IsPromptCharm(const AliAODMCParticle* part, TClonesArray* mcArray);
        ...
        std::vector<AliAnalysisTaskHFJets::AliHFJetDefinition>& GetJetDefinitions() { return fJetDefinitions; }
    ...
    protected:
        ...
        Double_t                           fTrackEfficiency       ; //!<! Artificial tracking inefficiency (0...1) -> set automatically at ExecOnce by AliAnalysisTaskHFJets
        ...
        friend class AliAnalysisTaskHFJets;
    ...
    AliAnalysisTaskHFJets();
    AliAnalysisTaskHFJets(const char* name, Int_t nOutputTrees = 2);
    virtual ~AliAnalysisTaskHFJets();
    ...
    void SetTrackEfficiency(Double_t t)                 { fTrackEfficiency    = t ; }
    void SetRejectISR(Bool_t b)                         { fRejectISR          = b ; }
    void SetJetArea(Int_t type, Double_t garea = 0.005) { fJetAreaType        = type; fJetGhostArea = garea; }
    ...
    static AliAnalysisTaskHFJets* AddTaskHFJets(TString ntracks = "usedefault", TString nclusters = "usedefault", TString nMCpart = "", Int_t nMaxTrees = 2, TString suffix = "");
...
protected:
    ...
    std::list<AnalysisEngine> fAnalysisEngines      ; ///<  Array of analysis parameters
    UInt_t               fEnabledAxis               ; ///<  Use bit defined in EAxis_t to enable axis in the THnSparse
...
private:
    ...
    AliAnalysisTaskHFJets(const AliAnalysisTaskHFJets& source);
    AliAnalysisTaskHFJets& operator=(const AliAnalysisTaskHFJets& source);
    
    /// \cond CLASSIMP
    ClassDef(AliAnalysisTaskHFJets, 10);
    /// \endcond
};
