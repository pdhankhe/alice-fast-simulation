#ifndef THEPMCPARSER_DEV_H
#define THEPMCPARSER_DEV_H
...
public:
   ...
   inline THepMCParser_dev() : fTree(0) {;} // nullptr in c++11
   inline virtual ~THepMCParser_dev() {;} // should be a memory management of the TTree...

   // The actual useful constructors, either take:
   //  - a file name for a file with HepMC data or
   //  - a HepMC event data structure
   THepMCParser_dev(const char *);
   THepMCParser_dev(HepMC::IO_BaseClass *);
