...
using namespace EnergyCorrelators;

AliAnalysisTaskHFJets::AliEventNotFound::AliEventNotFound(const std::string& class_name, const std::string& method_name) :
std::exception(),
...
const char* AliAnalysisTaskHFJets::AliEventNotFound::what() const noexcept
{
    return fWhat.c_str();
}
#endif
...
// Definitions of class AliAnalysisTaskHFJets::AliEventInfoSummary

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliEventInfoSummary);
/// \endcond
...
AliAnalysisTaskHFJets::AliEventInfoSummary::AliEventInfoSummary(EventInfo event) :
fWeight(1),
fPtHard(0)
{
    Set(event);
...
/// Reset the object
void AliAnalysisTaskHFJets::AliEventInfoSummary::Reset()
{
    fWeight = 1;
    fPtHard = 0;
}
...
/// \param cent Event centrality
/// \param ep Event plane
void AliAnalysisTaskHFJets::AliEventInfoSummary::Set(EventInfo event)
{
...
// Definitions of class AliAnalysisTaskHFJets::AliJetInfo

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliJetInfo);
/// \endcond
...
Double_t AliAnalysisTaskHFJets::AliJetInfo::GetDistance(const AliJetInfo& jet, Double_t& deta, Double_t& dphi) const
{
...
/// \param jet Const reference to a AliJetInfo object
/// \return The distance between this jet and the jet reference provided
Double_t AliAnalysisTaskHFJets::AliJetInfo::GetDistance(const AliJetInfo& jet) const
{
    Double_t deta = 0;
    Double_t dphi = 0;
...
// Definitions of class AliAnalysisTaskHFJets::AliDmesonJetInfo

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliDmesonJetInfo);
/// \endcond

/// Default constructor
AliAnalysisTaskHFJets::AliDmesonJetInfo::AliDmesonJetInfo() :
fDmesonParticle(0),
fD(),
fSoftPionPt(0),
fInvMass2Prong(0),
...
AliAnalysisTaskHFJets::AliDmesonJetInfo::AliDmesonJetInfo(const AliDmesonJetInfo& source) :
...
///
/// \param source AliDmesonJetInfo object to copy from
AliAnalysisTaskHFJets::AliDmesonJetInfo& AliAnalysisTaskHFJets::AliDmesonJetInfo::operator=(const AliDmesonJetInfo& source)
{
...
void AliAnalysisTaskHFJets::AliDmesonJetInfo::Reset()
{
    ...
    for(auto& jet : fJets) {
        ...
        jet.second.fZg = -0.004;
        jet.second.fRg = -0.004;
        jet.second.fNSD = -1;
        jet.second.fPt_splitting = -1;
        jet.second.fK0 = -0.004;
        jet.second.fK1 = -0.004;
        jet.second.fK2 = -0.004;
        jet.second.fKT = -1;
        jet.second.fZK0 = -0.004;
        jet.second.fZK1 = -0.004;
        jet.second.fZK2 = -0.004;
        jet.second.fZKT = -0.004;
        jet.second.fRK0 = -0.004;
        jet.second.fRK1 = -0.004;
        jet.second.fRK2 = -0.004;
        jet.second.fRKT = -0.004;
        jet.second.fRKT = -0.004;
        jet.second.fLB1K1 = -0.004;
        jet.second.fLB15K1 = -0.004;
        jet.second.fLB2K1 = -0.004;
        jet.second.fLB3K1 = -0.004;
        jet.second.fR_std_default = -0.004;
        jet.second.fR_WTA = -0.004;
        jet.second.fR_SD = -0.004;
        jet.second.fR_STD_SD = -0.004;
        jet.second.fR_STD_WTA = -0.004;
        jet.second.fR_WTA_SD = -0.004;
    }
}

/// Prints the content of this object in the standard output.
void AliAnalysisTaskHFJets::AliDmesonJetInfo::Print() const
{
...
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::Get_lambda_beta_kappa(const fastjet::PseudoJet &j, double beta, double kappa,double scaleR0, bool check_user_index) const
{
...
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetDistance_jet(const fastjet::PseudoJet &j, Double_t& deta, Double_t& dphi) const
{
    dphi = TVector2::Phi_mpi_pi(fD.Phi() - j.phi());
    deta = fD.Eta() - j.eta();
    return TMath::Sqrt(dphi * dphi + deta * deta);
}
...
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetDistance_jet(const fastjet::PseudoJet &j) const
{
    Double_t deta = 0;
    Double_t dphi = 0;
    return GetDistance_jet(j, deta, dphi);
}
...
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetZ(std::string n) const
{
    ...
    if((*it).second.Pt() > 0) {
        ...
        if(jetMom < 1e-6) {
            ::Error("AliAnalysisTaskHFJets::AliDmesonJetInfo::GetZ", "Zero jet momentum!");
            z = 0.999;
        }
        else {
...
///
/// \return the fraction of the momentum of the particle parallel to the jet over the total jet momentum
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetCorrZ(std::string n) const
{
    std::map<std::string, AliJetInfo>::const_iterator it = fJets.find(n);
    if(it == fJets.end()) return 0;
...
/// \param dphi reference where the phi distance will be returned
/// \return The distance between the D meson and the jet axis
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetDistance(std::string n, Double_t& deta, Double_t& dphi) const
{
    std::map<std::string, AliJetInfo>::const_iterator it = fJets.find(n);
    if(it == fJets.end()) return 0;
...
/// \param n Name of the jet definition
/// \return The distance between the D meson and the jet axis
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetDistance(std::string n) const
{
    Double_t deta = 0;
    Double_t dphi = 0;
...
/// \param dphi reference where the phi distance will be returned
/// \return The distance between the D meson and the jet axis
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetDistance(const AliJetInfo& jet, Double_t& deta, Double_t& dphi) const
{
...
/// \param jet Const reference to a AliJetInfo object
/// \return The distance between the D meson and the jet axis
Double_t AliAnalysisTaskHFJets::AliDmesonJetInfo::GetDistance(const AliJetInfo& jet) const
{
    Double_t deta = 0;
    Double_t dphi = 0;
    return GetDistance(jet, deta, dphi);
...
const AliAnalysisTaskHFJets::AliJetInfo* AliAnalysisTaskHFJets::AliDmesonJetInfo::GetJet(std::string n) const
{
    std::map<std::string, AliJetInfo>::const_iterator it = fJets.find(n);
    if(it == fJets.end()) {
        ::Error("AliAnalysisTaskHFJets::AliDmesonJetInfo::GetJet", "Could not find jet info for the jet definition '%s'!",
                n.c_str());
        return 0;
    }
    return &((*it).second);
...
AliAnalysisTaskHFJets::AliJetInfo* AliAnalysisTaskHFJets::AliDmesonJetInfo::GetJet(std::string n)
{
...
// Definitions of class AliAnalysisTaskHFJets::AliJetInfoSummary

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliJetInfoSummary);
/// \endcond
...
AliAnalysisTaskHFJets::AliJetInfoSummary::AliJetInfoSummary(const AliDmesonJetInfo& source, std::string n) :
fPt(0),
fEta(0),
fPhi(0),
fR(0),
...
void AliAnalysisTaskHFJets::AliJetInfoSummary::Reset()
{
    fPt = 0;
    fEta = 0;
    fPhi = 0;
...
/// \param source A const reference to a valid AliDmesonJetInfo object
/// \param i      Index of the jet to be copied
void AliAnalysisTaskHFJets::AliJetInfoSummary::Set(const AliDmesonJetInfo& source, std::string n)
{
...
void AliAnalysisTaskHFJets::AliJetInfoSummary::Set(const AliJetInfo& source)
{
    fPt = source.Pt();
    fEta = source.Eta();
    ...
    fRg = source.Rg();
    fNSD = source.NSD();
    fPt_splitting = source.Pt_splitting();
    fK0 = source.K0();
    fK1 = source.K1();
    fK2 = source.K2();
    fKT = source.KT();
    ...
    fRKT = source.RKT();
    fLB1K1 = source.LB1K1();
    fLB15K1 = source.LB15K1();
    fLB2K1 = source.LB2K1();
    fLB3K1 = source.LB3K1();
    fR_std_default = source.R_std_default();
    fR_WTA = source.R_WTA();
    fR_SD = source.R_SD();
    fR_STD_SD = source.R_STD_SD();
    fR_STD_WTA = source.R_STD_WTA();
    fR_WTA_SD = source.R_WTA_SD();
...
/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliJetInfoPbPbSummary);
/// \endcond
...
/// \param source A const reference to a valid AliDmesonJetInfo object
/// \param i      Index of the jet to be copied
AliAnalysisTaskHFJets::AliJetInfoPbPbSummary::AliJetInfoPbPbSummary(const AliDmesonJetInfo& source, std::string n) :
AliJetInfoSummary(),
fCorrPt(0),
fCorrZ(0),
fArea(0)
...
/// Reset the current object
void AliAnalysisTaskHFJets::AliJetInfoPbPbSummary::Reset()
{
...
///
/// \param source A const reference to a valid AliJetInfo object
void AliAnalysisTaskHFJets::AliJetInfoPbPbSummary::Set(const AliJetInfo& source)
{
...
/// \param source A const reference to a valid AliDmesonJetInfo object
/// \param i      Index of the jet to be copied
void AliAnalysisTaskHFJets::AliJetInfoPbPbSummary::Set(const AliDmesonJetInfo& source, std::string n)
{
    AliJetInfoSummary::Set(source, n);
    fCorrZ = source.GetCorrZ(n);
}

// Definitions of class AliAnalysisTaskHFJets::AliDmesonInfoSummary

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliDmesonInfoSummary);
/// \endcond
...
///
/// \param source A const reference to a valid AliDmesonJetInfo object
void AliAnalysisTaskHFJets::AliDmesonInfoSummary::Set(const AliDmesonJetInfo& source)
{
    fPt = source.fD.Pt();
    fEta = source.fD.Eta();
...
/// Reset the object
void AliAnalysisTaskHFJets::AliDmesonInfoSummary::Reset()
{
    fPt = 0;
    fEta = 0;
    fPhi = 0;
...
/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliDmesonMCInfoSummary);
/// \endcond

/// Constructor that uses an AliDmesonJetInfo as its source
///
/// \param source A const reference to a valid AliDmesonJetInfo object
AliAnalysisTaskHFJets::AliDmesonMCInfoSummary::AliDmesonMCInfoSummary(const AliDmesonJetInfo& source) :
...
///
/// \param source A const reference to a valid AliDmesonJetInfo object
void AliAnalysisTaskHFJets::AliDmesonMCInfoSummary::Set(const AliDmesonJetInfo& source)
{
...
/// Reset the object
void AliAnalysisTaskHFJets::AliDmesonMCInfoSummary::Reset()
{
...
// Definitions of class AliAnalysisTaskHFJets::AliD0InfoSummary

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliD0InfoSummary);
/// \endcond

/// Constructor that uses an AliDmesonJetInfo as its source
///
/// \param source A const reference to a valid AliDmesonJetInfo object
AliAnalysisTaskHFJets::AliD0InfoSummary::AliD0InfoSummary(const AliDmesonJetInfo& source) :
AliDmesonInfoSummary(source),
...
///
/// \param source A const reference to a valid AliDmesonJetInfo object
void AliAnalysisTaskHFJets::AliD0InfoSummary::Set(const AliDmesonJetInfo& source)
{
    fInvMass = source.fD.M();
...
/// Reset the object
void AliAnalysisTaskHFJets::AliD0InfoSummary::Reset()
{
    AliDmesonInfoSummary::Reset();
    fSelectionType = 0;
    fInvMass = 0;
...
// Definitions of class AliAnalysisTaskHFJets::AliD0ExtendedInfoSummary

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliD0ExtendedInfoSummary);
/// \endcond

/// Constructor that uses an AliDmesonJetInfo as its source
///
/// \param source A const reference to a valid AliDmesonJetInfo object
AliAnalysisTaskHFJets::AliD0ExtendedInfoSummary::AliD0ExtendedInfoSummary(const AliDmesonJetInfo& source) :
...
///
/// \param source A const reference to a valid AliDmesonJetInfo object
void AliAnalysisTaskHFJets::AliD0ExtendedInfoSummary::Set(const AliDmesonJetInfo& source)
{
    ...
    if(recoDecay) {
        ...
        if(source.fEvent) {
            ...
            throw AliAnalysisTaskHFJets::AliEventNotFound("AliAnalysisTaskHFJets::AliDmesonJetInfo", "fEvent");
        }
...
/// Reset the object
void AliAnalysisTaskHFJets::AliD0ExtendedInfoSummary::Reset()
{
...
// Definitions of class AliAnalysisTaskHFJets::AliDStarInfoSummary

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliDStarInfoSummary);
/// \endcond

/// Constructor that uses an AliDmesonJetInfo as its source
///
/// \param source A const reference to a valid AliDmesonJetInfo object
AliAnalysisTaskHFJets::AliDStarInfoSummary::AliDStarInfoSummary(const AliDmesonJetInfo& source) :
AliDmesonInfoSummary(source),
...
///
/// \param source A const reference to a valid AliDmesonJetInfo object
void AliAnalysisTaskHFJets::AliDStarInfoSummary::Set(const AliDmesonJetInfo& source)
{
    f2ProngInvMass = source.fInvMass2Prong;
    fDeltaInvMass = source.fD.M() - source.fInvMass2Prong;
    AliDmesonInfoSummary::Set(source);
...
// Definitions of class AliAnalysisTaskHFJets::OutputHandler

/// Constructor
AliAnalysisTaskHFJets::OutputHandler::OutputHandler() :
...
/// Constructor
AliAnalysisTaskHFJets::OutputHandler::OutputHandler(AnalysisEngine* eng) :
...
/// Fills QA histograms. This method is not used by the AliAnalysisTaskHFJets task,
/// but can be used by derived tasks that have a custom implementation to fill the output objects.
///
/// \return Always kTRUE
Bool_t AliAnalysisTaskHFJets::OutputHandler::FillOutput(Bool_t applyKinCuts)
{
    TString hname;
...
// Definitions of class AliAnalysisTaskHFJets::OutputHandlerTHnSparse

/// Constructor
AliAnalysisTaskHFJets::OutputHandlerTHnSparse::OutputHandlerTHnSparse() :
OutputHandler(),
fEnabledAxis(0)
{
}
...
/// Constructor
AliAnalysisTaskHFJets::OutputHandlerTHnSparse::OutputHandlerTHnSparse(AnalysisEngine* eng) :
OutputHandler(eng),
fEnabledAxis(0)
{
}
...
void AliAnalysisTaskHFJets::OutputHandlerTHnSparse::BuildOutputObject(const char* /*taskName*/)
{
    TString hname;
    ...
    for(auto& jetDef : *fJetDefinitions) {
        ...
        AliDebugGeneralStream("AliAnalysisTaskHFJets::OutputHandlerTHnSparse::BuildOutputObject", 2) << "Now working on '" << jetDef.GetName() << "'" << std::endl;
...
Bool_t AliAnalysisTaskHFJets::OutputHandlerTHnSparse::IsAnyJetInAcceptance(const AliDmesonJetInfo& dMesonJet) const
{
...
Bool_t AliAnalysisTaskHFJets::OutputHandlerTHnSparse::FillOutput(Bool_t applyKinCuts)
{
    TString hname;
...
/// \param n          Jet name
Bool_t AliAnalysisTaskHFJets::OutputHandlerTHnSparse::FillHnSparse(THnSparse* h, const AliDmesonJetInfo& DmesonJet, std::string n)
{
    ...
    for(Int_t i = 0; i < h->GetNdimensions(); i++) {
        ...
        if(title == "#it{p}_{T,D} (GeV/#it{c})")                     contents[i] = DmesonJet.fD.Pt();
            ...
            AliWarningGeneralStream("AliAnalysisTaskHFJets::OutputHandlerTHnSparse::FillHnSparse") << "Unable to fill dimension '" << title.Data() << "'!" << std::endl;
        }
    }
...
// Definitions of class AliAnalysisTaskHFJets::OutputHandlerTTree

/// Constructor
AliAnalysisTaskHFJets::OutputHandlerTTree::OutputHandlerTTree() :
OutputHandler(),
fDataSlotNumber(-1),
fTree(0),
...
/// Constructor
AliAnalysisTaskHFJets::OutputHandlerTTree::OutputHandlerTTree(AnalysisEngine* eng) :
OutputHandler(eng),
fDataSlotNumber(-1),
fTree(0),
fCurrentDmesonJetInfo(0),
...
void AliAnalysisTaskHFJets::OutputHandlerTTree::BuildOutputObject(const char* taskName)
{
    TString classname;
    if(fMCMode == kMCTruth) {
        classname = "AliAnalysisTaskHFJets::AliDmesonMCInfoSummary";
        ...
        switch(fCandidateType) {
            ...
            case kD0toKpiLikeSign:
                if(fD0Extended) {
                    classname = "AliAnalysisTaskHFJets::AliD0ExtendedInfoSummary";
                    fCurrentDmesonJetInfo = new AliD0ExtendedInfoSummary();
                }
                else {
                    classname = "AliAnalysisTaskHFJets::AliD0InfoSummary";
                    fCurrentDmesonJetInfo = new AliD0InfoSummary();
                }
                break;
            case kDstartoKpipi:
                classname = "AliAnalysisTaskHFJets::AliDStarInfoSummary";
    ...
    for(Int_t i = 0; i < fJetDefinitions->size(); i++) {
        if(fJetDefinitions->at(i).fRhoName.IsNull()) {
            ...
            fTree->Branch(fJetDefinitions->at(i).GetName(), "AliAnalysisTaskHFJets::AliJetInfoSummary", &fCurrentJetInfo[i]);
        }
        else {
            fCurrentJetInfo[i] = new AliJetInfoPbPbSummary();
            fTree->Branch(fJetDefinitions->at(i).GetName(), "AliAnalysisTaskHFJets::AliJetInfoPbPbSummary", &fCurrentJetInfo[i]);
        }
    }
}
...
///
/// \return kTRUE on success
Bool_t AliAnalysisTaskHFJets::OutputHandlerTTree::FillOutput(Bool_t applyKinCuts)
{
    TString hname;
...
// Definitions of class AliAnalysisTaskHFJets::OutputHandlerTTreeExtended

/// Constructor
AliAnalysisTaskHFJets::OutputHandlerTTreeExtendedBase::OutputHandlerTTreeExtendedBase() :
OutputHandler(),
fDataSlotNumber(-1),
fTree(0),
fEventClassName(),
...
/// Constructor
AliAnalysisTaskHFJets::OutputHandlerTTreeExtendedBase::OutputHandlerTTreeExtendedBase(AnalysisEngine* eng) :
OutputHandler(eng),
fDataSlotNumber(-1),
fTree(0),
fEventClassName(),
...
///
/// \return Pointer to the new tree
AliAnalysisTaskHFJets::OutputHandlerTTreeExtendedBase* AliAnalysisTaskHFJets::OutputHandlerTTreeExtendedBase::GenerateOutputHandler(AnalysisEngine* eng)
{
    TString event_class_name = "AliAnalysisTaskHFJets::AliEventInfoSummary";
    TString d_meson_class_name;
    
    TString jet_class_name = "std::vector<AliAnalysisTaskHFJets::AliJetInfoSummary>";
    Bool_t RhoJet = kFALSE;
    for(auto jetDef : eng->GetJetDefinitions()) {
        if(!jetDef.fRhoName.IsNull()) {
            RhoJet = kTRUE;
            jet_class_name = "std::vector<AliAnalysisTaskHFJets::AliJetInfoPbPbSummary>";
        }
    }
    
    OutputHandlerTTreeExtendedBase* result = nullptr;
    if(eng->GetMCMode() == kMCTruth) {
        d_meson_class_name = "std::vector<AliAnalysisTaskHFJets::AliDmesonMCInfoSummary>";
        if(RhoJet) {
            result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliDmesonMCInfoSummary, AliJetInfoPbPbSummary>(eng);
        }
        else {
            result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliDmesonMCInfoSummary, AliJetInfoSummary>(eng);
        }
    }
    else {
        switch(eng->GetCandidateType()) {
            ...
            case kD0toKpiLikeSign:
                if(eng->IsD0Extended()) {
                    d_meson_class_name = "std::vector<AliAnalysisTaskHFJets::AliD0ExtendedInfoSummary>";
                    if(RhoJet) {
                        result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliD0ExtendedInfoSummary, AliJetInfoPbPbSummary>(eng);
                    }
                    else {
                        result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliD0ExtendedInfoSummary, AliJetInfoSummary>(eng);
                    }
                }
                else {
                    d_meson_class_name = "AliAnalysisTaskHFJets::AliD0InfoSummary";
                    if(RhoJet) {
                        result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliD0InfoSummary, AliJetInfoPbPbSummary>(eng);
                    }
                    else {
                        result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliD0InfoSummary, AliJetInfoSummary>(eng);
                    }
                }
                break;
            case kDstartoKpipi:
                d_meson_class_name = "AliAnalysisTaskHFJets::AliDStarInfoSummary";
                if(RhoJet) {
                    result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliDStarInfoSummary, AliJetInfoPbPbSummary>(eng);
                }
                else {
                    result = new AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<AliEventInfoSummary, AliDStarInfoSummary, AliJetInfoSummary>(eng);
                }
                break;
        }
    }
...
AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<EVENTTYPE, DMESONTYPE, JETTYPE>::OutputHandlerTTreeExtended() :
...
/// Constructor
template<class EVENTTYPE, class DMESONTYPE, class JETTYPE>
AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<EVENTTYPE, DMESONTYPE, JETTYPE>::OutputHandlerTTreeExtended(AnalysisEngine* eng) :
...
/// \return Pointer to the new tree
template<class EVENTTYPE, class DMESONTYPE, class JETTYPE>
void AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<EVENTTYPE, DMESONTYPE, JETTYPE>::BuildOutputObject(const char* taskName)
{
    TString treeName = TString::Format("%s_%s", taskName, fName.Data());
    fTree = new TTree(treeName, treeName);
...
/// \return kTRUE on success
template<class EVENTTYPE, class DMESONTYPE, class JETTYPE>
Bool_t AliAnalysisTaskHFJets::OutputHandlerTTreeExtended<EVENTTYPE, DMESONTYPE, JETTYPE>::FillOutput(Bool_t applyKinCuts)
{
...
// Definitions of class AliAnalysisTaskHFJets::AliJetDefinition

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AliHFJetDefinition);
/// \endcond

/// This is the default constructor, used for ROOT I/O purposes.
AliAnalysisTaskHFJets::AliHFJetDefinition::AliHFJetDefinition() :
TObject(),
...
AliAnalysisTaskHFJets::AliHFJetDefinition::AliHFJetDefinition(EJetType_t type, Double_t r, EJetAlgo_t algo, ERecoScheme_t reco) :
TObject(),
fJetType(type),
fRadius(r),
fJetAlgo(algo),
...
/// \param algo Jet algorithm (anit-kt, kt,...)
/// \param reco Jet recombination scheme (pt_scheme, E_scheme,...)
AliAnalysisTaskHFJets::AliHFJetDefinition::AliHFJetDefinition(EJetType_t type, Double_t r, EJetAlgo_t algo, ERecoScheme_t reco, TString rhoName) :
TObject(),
fJetType(type),
fRadius(r),
fJetAlgo(algo),
...
AliAnalysisTaskHFJets::AliHFJetDefinition::AliHFJetDefinition(const AliHFJetDefinition& source) :
TObject(),
...
///
/// \param source Reference to an AliJetDefinition object to copy from
AliAnalysisTaskHFJets::AliHFJetDefinition& AliAnalysisTaskHFJets::AliHFJetDefinition::operator=(const AliHFJetDefinition& source)
{
...
const char* AliAnalysisTaskHFJets::AliHFJetDefinition::GetName() const
{
    static TString name;
...
Bool_t AliAnalysisTaskHFJets::AliHFJetDefinition::IsJetInAcceptance(const AliJetInfo& jet) const
{
...
/// \param jet Const reference to a AliJetInfo object
/// \return kTRUE if the jet passes the cuts
Bool_t AliAnalysisTaskHFJets::AliHFJetDefinition::IsJetInAcceptance(const AliDmesonJetInfo& dMesonJet, std::string n) const
{
...
bool operator<(const AliAnalysisTaskHFJets::AliHFJetDefinition& lhs, const AliAnalysisTaskHFJets::AliHFJetDefinition& rhs)
{
...
// Definitions of class AliAnalysisTaskHFJets::AnalysisEngine

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets::AnalysisEngine);
/// \endcond

/// This is the default constructor, used for ROOT I/O purposes.
AliAnalysisTaskHFJets::AnalysisEngine::AnalysisEngine() :
TObject(),
fCandidateType(kD0toKpi),
fCandidateName(),
fCandidatePDG(0),
...
AliAnalysisTaskHFJets::AnalysisEngine::AnalysisEngine(ECandidateType_t type, EMCMode_t MCmode, AliRDHFCuts* cuts, Int_t nMassBins, Double_t range) :
TObject(),
fCandidateType(type),
fCandidateName(),
fCandidatePDG(0),
...
AliAnalysisTaskHFJets::AnalysisEngine::AnalysisEngine(const AliAnalysisTaskHFJets::AnalysisEngine& source) :
TObject(source),
...
///
/// \param source Reference to a valid AnalysisEngine to copy from.
AliAnalysisTaskHFJets::AnalysisEngine& AliAnalysisTaskHFJets::AnalysisEngine::operator=(const AnalysisEngine& source)
{
...
void AliAnalysisTaskHFJets::AnalysisEngine::Init(const AliEMCALGeometry* const /*geom*/, Int_t /*runNumber*/)
{
}
...
void AliAnalysisTaskHFJets::AnalysisEngine::SetCandidateProperties(Double_t range)
{
    switch(fCandidateType) {
        ...
        case kLctopK0s:
            ...
            fPDGdaughters[1] = 310;  // K0S
            fBranchName = "LctopK0s";
            fAcceptedDecay = kDecayLctopK0s;
            break;
        case kD0toKpi:
            fCandidatePDG = 421;
            fCandidateName = "D0";
        ...
        case kDstartoKpipi:
            ...
            break;
        default:
            ::Error("AliAnalysisTaskHFJets::AnalysisEngine::SetCandidateProperties", "Candidate %d unknown!", fCandidateType);
    }
...
void AliAnalysisTaskHFJets::AnalysisEngine::AdoptRDHFCuts(AliRDHFCuts* cuts)
{
...
///
/// \param Pointer to a AliRDHFCuts object.
void AliAnalysisTaskHFJets::AnalysisEngine::SetRDHFCuts(AliRDHFCuts* cuts)
{
    if(!cuts) return;
    if(fRDHFCuts) delete fRDHFCuts;
...
const char* AliAnalysisTaskHFJets::AnalysisEngine::GetName(const AliHFJetDefinition& jetDef) const
{
    static TString name;
...
///
/// \param i  Index of the jet radius array.
const char* AliAnalysisTaskHFJets::AnalysisEngine::GetName() const
{
...
AliAnalysisTaskHFJets::AliHFJetDefinition* AliAnalysisTaskHFJets::AnalysisEngine::AddJetDefinition(const AliAnalysisTaskHFJets::AliHFJetDefinition& def)
{
    ...
    if(it == fJetDefinitions.end() || *it != def) {   // No jet definition was found, adding a new one
        ...
        ::Info("AliAnalysisTaskHFJets::AnalysisEngine::AddJetDefinition", "Jet definition '%s' has been added to analysis engine '%s'."
        ...
        ::Warning("AliAnalysisTaskHFJets::AnalysisEngine::AddJetDefinition", "The same jet definition '%s' was already added in analysis engine '%s'.", def.GetName(), GetName());
    }
...
///
/// \return Pointer to the new jet definition (or to the one that was already present)
AliAnalysisTaskHFJets::AliHFJetDefinition*
AliAnalysisTaskHFJets::AnalysisEngine::AddJetDefinition(EJetType_t type, Double_t r, EJetAlgo_t algo, ERecoScheme_t reco)
{
...
std::vector<AliAnalysisTaskHFJets::AliHFJetDefinition>::iterator AliAnalysisTaskHFJets::AnalysisEngine::FindJetDefinition(const AliAnalysisTaskHFJets::AliHFJetDefinition& def)
{
...
void AliAnalysisTaskHFJets::AnalysisEngine::SetJetPhiRange(Double_t min, Double_t max)
{
...
/// \param min Lower bound
/// \param max Upper bound
void AliAnalysisTaskHFJets::AnalysisEngine::SetJetEtaRange(Double_t min, Double_t max)
{
...
/// \param min Lower bound
/// \param max Upper bound
void AliAnalysisTaskHFJets::AnalysisEngine::SetJetPtRange(Double_t min, Double_t max)
{
...
/// \param min Lower bound
/// \param max Upper bound
void AliAnalysisTaskHFJets::AnalysisEngine::SetChargedPtRange(Double_t min, Double_t max)
{
...
/// \param min Lower bound
/// \param max Upper bound
void AliAnalysisTaskHFJets::AnalysisEngine::SetNeutralPtRange(Double_t min, Double_t max)
{
...
bool operator<(const AliAnalysisTaskHFJets::AnalysisEngine& lhs, const AliAnalysisTaskHFJets::AnalysisEngine& rhs)
{
...
///
/// \return kTRUE on success
Bool_t AliAnalysisTaskHFJets::AnalysisEngine::ExtractD0Attributes(const AliAODRecoDecayHF2Prong* Dcand, AliDmesonJetInfo& DmesonJet, UInt_t i)
{
...
///
/// \return kTRUE on success
Bool_t AliAnalysisTaskHFJets::AnalysisEngine::ExtractDstarAttributes(const AliAODRecoCascadeHF* DstarCand, AliDmesonJetInfo& DmesonJet, UInt_t i)
{
...
///
/// \return One of the enum constants of AliAnalysisTaskHFJets::EMesonDecayChannel_t (D0->Kpi or D*->D0pi->Kpipi)
AliAnalysisTaskHFJets::EMesonDecayChannel_t AliAnalysisTaskHFJets::AnalysisEngine::CheckDecayChannel(const AliAODMCParticle* part, TClonesArray* mcArray)
{
    ...
    if(part->GetNDaughters() == 2) {
        ...
        if(absPdgPart == 4122) {  // Lc -> p K0S
            if((absPdg1 == 2212 && absPdg2 == 310) ||  // p K0S
               (absPdg1 == 310 && absPdg2 == 2212)) { // K0S p
                decay = kDecayLctopK0s;
            }
        }
    }
...
std::pair<AliAnalysisTaskHFJets::EMesonOrigin_t, AliAODMCParticle*> AliAnalysisTaskHFJets::AnalysisEngine::IsPromptCharm(const AliAODMCParticle* part, TClonesArray* mcArray)
{
    std::pair<AliAnalysisTaskHFJets::EMesonOrigin_t, AliAODMCParticle*> result(kUnknownQuark, 0);
...
AliAODMCParticle* AliAnalysisTaskHFJets::AnalysisEngine::FindParticleOrigin(const AliAODMCParticle* part, TClonesArray* mcArray, EFindParticleOriginMode_t mode)
{
...
AliAODMCParticle* AliAnalysisTaskHFJets::AnalysisEngine::FindParticleOrigin(const AliAODMCParticle* part, TClonesArray* mcArray, EFindParticleOriginMode_t mode, const std::set<UInt_t>& pdgSet)
{
...
/// Run the analysis
void AliAnalysisTaskHFJets::AnalysisEngine::RunAnalysis()
{
    for(auto& jetDef : fJetDefinitions) {
        jetDef.fJets.clear();
    }
...
void AliAnalysisTaskHFJets::AnalysisEngine::RunDetectorLevelAnalysis()
{
...
Bool_t AliAnalysisTaskHFJets::AnalysisEngine::FindJet(AliAODRecoDecayHF2Prong* Dcand, AliDmesonJetInfo& DmesonJet, AliHFJetDefinition& jetDef)
{
    TString hname;
    ...
    for(UInt_t ijet = 0; ijet < jets_incl.size(); ++ijet) {
        ...
        if(isDmesonJet) {
            ...
            DmesonJet.fJets[jetDef.GetName()].fPt_splitting = 0;
            ...
            DmesonJet.fJets[jetDef.GetName()].fZK0 = 0;
            DmesonJet.fJets[jetDef.GetName()].fZK1 = 0;
            DmesonJet.fJets[jetDef.GetName()].fZK2 = 0;
            DmesonJet.fJets[jetDef.GetName()].fZKT = 0;
            DmesonJet.fJets[jetDef.GetName()].fRK0 = 0;
            DmesonJet.fJets[jetDef.GetName()].fRK1 = 0;
            DmesonJet.fJets[jetDef.GetName()].fRK2 = 0;
            DmesonJet.fJets[jetDef.GetName()].fRKT = 0;
            DmesonJet.fJets[jetDef.GetName()].fLB1K1 = 0;
            DmesonJet.fJets[jetDef.GetName()].fLB15K1 = 0;
            DmesonJet.fJets[jetDef.GetName()].fLB2K1 = 0;
            DmesonJet.fJets[jetDef.GetName()].fLB3K1 = 0;
            DmesonJet.fJets[jetDef.GetName()].fR_std_default = 0;
            DmesonJet.fJets[jetDef.GetName()].fR_WTA = 0;
            DmesonJet.fJets[jetDef.GetName()].fR_SD = 0;
            DmesonJet.fJets[jetDef.GetName()].fR_STD_SD = 0;
            DmesonJet.fJets[jetDef.GetName()].fR_STD_WTA = 0;
            DmesonJet.fJets[jetDef.GetName()].fR_WTA_SD = 0;
...
void AliAnalysisTaskHFJets::AnalysisEngine::AddInputVectors(AliEmcalContainer* cont, Int_t offset, TH2* rejectHist, Double_t eff)
{
...
void AliAnalysisTaskHFJets::AnalysisEngine::RunParticleLevelAnalysis()
{
    TString hname;
    ...
    for(auto& jetDef : fJetDefinitions) {
        ...
        hname = TString::Format("%s/%s/fHistjetptVsDptVsConstz", GetName(), jetDef.GetName());
        TH3*  histjetptVsDptVsConstz = static_cast<TH3*>(fHistManager->FindObject(hname));
        ...
        for(auto jet : jets_incl) {
            ...
            Int_t iNSD = 0;
            Float_t dPt_splitting = 0.0, dPt_splittingTmp = 0.0;
            Float_t dK0 = 0.0, dK0Tmp = 0.0, dZK0 = 0.0, dRK0 = 0.0;
            Float_t dK1 = 0.0, dK1Tmp = 0.0, dZK1 = 0.0, dRK1 = 0.0;
            Float_t dK2 = 0.0, dK2Tmp = 0.0, dZK2 = 0.0, dRK2 = 0.0;
            Float_t dKT = 0.0, dKTTmp = 0.0, dZKT = 0.0, dRKT = 0.0;
            ...
            std::vector<fastjet::PseudoJet> reclustered_jet = fastjet::sorted_by_pt(cluster_sequence.inclusive_jets(fMinSubJetPt));
            ...
            while(daughter_jet.has_parents(parent_subjet_1, parent_subjet_2)) {
                if(parent_subjet_1.perp() < parent_subjet_2.perp())
                    std::swap(parent_subjet_1, parent_subjet_2);
                dPt_splittingTmp = parent_subjet_1.perp() + parent_subjet_2.perp();
                dZgTmp = parent_subjet_2.perp() / dPt_splittingTmp;
                ...
                if(dZgTmp >= fSoftDropZCut * TMath::Power(dRgTmp / jetDef.fRadius, fSoftDropBeta)) {
                    if(!bSoftdropped) {
                        dZg = dZgTmp;
                        dRg = dRgTmp;
                        dPt_splitting = dPt_splittingTmp;
                        bSoftdropped = kTRUE;
                    }
                    iNSD++;
                }
                if(Pt_jet > 0.0) {
                    dK0Tmp = (1.0 / Pt_jet) * dZgTmp * (1 - dZgTmp) * dPt_splittingTmp * TMath::Power(dRgTmp / jetDef.fRadius, 0.1);
                    dK1Tmp = (1.0 / Pt_jet) * dZgTmp * (1 - dZgTmp) * dPt_splittingTmp * TMath::Power(dRgTmp / jetDef.fRadius, 1);
                    dK2Tmp = (1.0 / Pt_jet) * dZgTmp * (1 - dZgTmp) * dPt_splittingTmp * TMath::Power(dRgTmp / jetDef.fRadius, 2);
                    dKTTmp = dZgTmp * dPt_splittingTmp * TMath::Sin(dRgTmp);
                    if(dK0Tmp > dK0) {
                        dK0 = dK0Tmp;
                        dZK0 = dZgTmp;
                        dRK0 = dRgTmp;
            ...
            Double_t z_const_momentum_fraction =0;
            fastjet::PseudoJet Dmeson;
            UShort_t Dparton_type = 0;
            for(auto constituent : jet.constituents()) {
                ...
                if(!part) {
                    ::Error("AliAnalysisTaskHFJets::AnalysisEngine::RunParticleLevelAnalysis", "Could not find jet constituent %d!", iPart);
                    continue;
                }
                if(TMath::Abs(part->PdgCode()) == fCandidatePDG) {
                    ...
                    if(iNSD > 0) // keep the default values if no Soft Drop
                    {
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fZg = dZg;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fRg = dRg;
                    }
                    if(jet.constituents().size() > 1)  // keep the default values for single-constituent jets
                    {
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fNSD = iNSD;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fPt_splitting = dPt_splitting;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fK0 = dK0;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fK1 = dK1;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fK2 = dK2;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fKT = dKT;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fZK0 = dZK0;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fZK1 = dZK1;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fZK2 = dZK2;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fZKT = dZKT;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fRK0 = dRK0;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fRK1 = dRK1;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fRK2 = dRK2;
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fRKT = dRKT;
                    }
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fArea = jet.area();
                    AliAnalysisTaskHFJets::AliDmesonJetInfo np;
                    //AliDmesonJetInfo& DmesoninJet;
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fLB1K1 = np.Get_lambda_beta_kappa(jet,1.0,1.0,0.4,false);
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fLB15K1 = np.Get_lambda_beta_kappa(jet,1.5,1.0,0.4,false);
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fLB2K1 = np.Get_lambda_beta_kappa(jet,2.0,1.0,0.4,false);
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fLB3K1 = np.Get_lambda_beta_kappa(jet,3.0,1.0,0.4,false);
                    ...
                    // jets reclustred with C/A algorithm and recombined with E_scheme
                    fastjet::JetDefinition WTAJet_definition(fastjet::cambridge_algorithm, 2* jetDef.fRadius, fastjet::WTA_pt_scheme, fastjet::Best);
                    fastjet::ClusterSequence cluster_sequence_wta(jet.constituents(), WTAJet_definition);
                    std::vector<fastjet::PseudoJet> reclustered_jet_wta = fastjet::sorted_by_pt(cluster_sequence_wta.inclusive_jets(fMinSubJetPt));
                    fastjet::PseudoJet jet_wta = reclustered_jet_wta[0];
                    // =================================================================================
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fR_std_default = jet.delta_R((*dMesonJetIt).second.fD);
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fR_WTA = jet_wta.delta_R((*dMesonJetIt).second.fD);
                    (*dMesonJetIt).second.fJets[jetDef.GetName()].fR_STD_WTA = jet.delta_R(jet_wta);
                    
                    // jets reclustred with C/A algorithm and Soft drop
                    fastjet::JetDefinition SDJet_definition(fastjet::cambridge_algorithm, jetDef.fRadius, fastjet::E_scheme, fastjet::Best);
                    ...
                    fastjet::PseudoJet sd_jet = sd(jet_SD);
                    // =================================================================================
                    
                    if (sd_jet.constituents().size() < 1){ bSoftdroppedPass = kFALSE;}
                    
                    if (bSoftdroppedPass){
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fR_SD = sd_jet.delta_R((*dMesonJetIt).second.fD);
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fR_STD_SD = jet.delta_R(sd_jet);
                        (*dMesonJetIt).second.fJets[jetDef.GetName()].fR_WTA_SD = jet_wta.delta_R(sd_jet);
                    }
                    ...
                    thnsparse_jetinfo_value[0] = jet.pt();
                    thnsparse_jetinfo_value[1] = jet.eta();
                    thnsparse_jetinfo_value[2] = Dmeson.pt();
                    thnsparse_jetinfo_value[3] = Dparton_type;
                    thnsparse_jetinfo_value[4] = jet.constituents().size();
                    thnsparse_jetinfo->Fill(thnsparse_jetinfo_value);
                    
                    //EEC computation
                    std::vector<fastjet::PseudoJet> constituent_EEC = fastjet::sorted_by_pt(jet.constituents());
                    std::vector<fastjet::PseudoJet> c_select;
                    double trkthrd = 1;
                    for(int iconst=0; iconst< constituent_EEC.size(); iconst++) {
                        if (constituent_EEC[iconst].pt() < trkthrd) break;
                        c_select.push_back(constituent_EEC[iconst]);
                    }
                    
                    double dphi_cut = -9999;
                    double deta_cut = -9999;
                
                    
                    CorrelatorBuilder *ecorr = new CorrelatorBuilder(c_select, jet.perp(), 2, 1, dphi_cut, deta_cut);
                    for (int npair = 0; npair < ecorr->correlator(2)->rs()->size() ; npair++){
                        thnsparse_EEC_value[0] = jet.pt();
                        thnsparse_EEC_value[1] = jet.eta();
                        thnsparse_EEC_value[2] = Dmeson.pt();
                ...
                z_const_momentum_fraction = constituent.perp() / jet.perp();
                if(nDmesonsInJet > 0) histjetptVsDptVsConstz->Fill(jet.perp(),Dmeson.perp(), z_const_momentum_fraction);
                if(nDmesonsInJet > 0) histjetptVsDptVsNconstituents->Fill(jet.perp(),Dmeson.perp(), jet.constituents().size());
...
// Definitions of class AliAnalysisTaskHFJets

/// \cond CLASSIMP
ClassImp(AliAnalysisTaskHFJets);
/// \endcond

/// This is the default constructor, used for ROOT I/O purposes.
AliAnalysisTaskHFJets::AliAnalysisTaskHFJets() :
...
AliAnalysisTaskHFJets::AliAnalysisTaskHFJets(const char* name, Int_t nOutputTrees) :
...
AliRDHFCuts* AliAnalysisTaskHFJets::LoadDMesonCutsFromFile(TString cutfname, TString cutsname)
{
    AliRDHFCuts* analysiscuts = 0;
    TFile* filecuts = TFile::Open(cutfname);
    if(!filecuts || filecuts->IsZombie()) {
        ::Error("AliAnalysisTaskHFJets::LoadDMesonCutsFromFile", "Input file not found: will use std cuts.");
        filecuts = 0;
    }
    ...
    if(!analysiscuts) {
        ::Error("AliAnalysisTaskHFJets::LoadDMesonCutsFromFile", "Could not find analysis cuts '%s' in '%s'.", cutsname.Data(), cutfname.Data());
        if(filecuts) {
            filecuts->ls();
        }
    }
    else {
        ::Info("AliAnalysisTaskHFJets::LoadDMesonCutsFromFile", "Cuts '%s' loaded from file '%s'", cutsname.Data(), cutfname.Data());
    }
...
///
/// \return Pointer to the AnalysisEngine added to the list.
AliAnalysisTaskHFJets::AnalysisEngine* AliAnalysisTaskHFJets::AddAnalysisEngine(ECandidateType_t type, TString cutfname, TString cuttype, EMCMode_t MCmode, const AliHFJetDefinition& jetDef, TString rhoName)
{
    AliRDHFCuts* cuts = 0;
    ...
    if(it == fAnalysisEngines.end() || *it != eng) {   // No analysis engine was found, adding a new one
        ...
        ::Info("AliAnalysisTaskHFJets::AddAnalysisEngine", "A new analysis engine '%s' has been added. The total number of analysis engines is %lu.", eng.GetName(), fAnalysisEngines.size());
    }
    else {
        AnalysisEngine* found_eng = &(*it);
        ::Info("AliAnalysisTaskHFJets::AddAnalysisEngine", "An analysis engine '%s' with %lu jet definitions has been found. The total number of analysis engines is %lu. A new jet definition '%s' is being added.", found_eng->GetName(), found_eng->fJetDefinitions.size(), fAnalysisEngines.size(), jetDef.GetName());
        found_eng->AddJetDefinition(jetDef);
        
        if(cuts) {
            if(found_eng->fRDHFCuts != 0) ::Warning("AliAnalysisTaskHFJets::AddAnalysisEngine", "D meson cuts were already defined for this D meson type. They will be overwritten.");
...
std::list<AliAnalysisTaskHFJets::AnalysisEngine>::iterator AliAnalysisTaskHFJets::FindAnalysisEngine(const AliAnalysisTaskHFJets::AnalysisEngine& eng)
{
...
void AliAnalysisTaskHFJets::UserCreateOutputObjects()
{
    ...
    ::Info("AliAnalysisTaskHFJets::UserCreateOutputObjects", "Allocating histograms for task '%s' (%lu analysis engines)", GetName(), fAnalysisEngines.size());
    for(auto& param : fAnalysisEngines) {
        ::Info("AliAnalysisTaskHFJets::UserCreateOutputObjects", "Allocating histograms for analysis engine '%s' (%lu jet definitions)", param.GetName(), param.fJetDefinitions.size());
        ...
        if(param.fMCMode != kMCTruth) {
            if(param.fCandidateType == kD0toKpi || param.fCandidateType == kD0toKpiLikeSign || param.fCandidateType == kLctopK0s) {
        ...
        for(auto& jetDef : param.fJetDefinitions) {
            ::Info("AliAnalysisTaskHFJets::UserCreateOutputObjects", "Allocating histograms for jet definition '%s'", jetDef.GetName());
            ...
            if(param.fMCMode == kMCTruth) {
                ...
                hname = TString::Format("%s/%s/fHistjetptVsDptVsNconstituents", param.GetName(), jetDef.GetName());
                htitle = hname + ";#it{p}_{T,ch jet};Dpt;#it{N}_{constituents}";
                h3D = fHistManager.CreateTH3(hname, htitle, 100, 0, 100, 50, 0, 50, 51, -0.5, 50.5);
                
                hname = TString::Format("%s/%s/fThnSparse_EEC_Dmeson", param.GetName(), jetDef.GetName());
...
void AliAnalysisTaskHFJets::ExecOnce()
{
    ...
    for(auto& params : fAnalysisEngines) {
        ...
        for(auto& jetdef : params.fJetDefinitions) {
            if(!jetdef.fRhoName.IsNull()) {
                ...
                if(!jetdef.fRho) {
                    ::Error("AliAnalysisTaskHFJets::ExecOnce",
        ...
        if(!params.fRDHFCuts) {
            if(params.fMCMode == kMCTruth) {
                ::Warning("AliAnalysisTaskHFJets::ExecOnce",
...
///
/// \return kTRUE on success
Bool_t AliAnalysisTaskHFJets::Run()
{
    TString hname;
...
///
/// \return Always kTRUE
Bool_t AliAnalysisTaskHFJets::FillHistograms()
{
    for(auto& param : fAnalysisEngines) {
...
void AliAnalysisTaskHFJets::FillPartonLevelHistograms()
{
...
void AliAnalysisTaskHFJets::CalculateMassLimits(Double_t range, Int_t pdg, Int_t nbins, Double_t& minMass, Double_t& maxMass)
{
...
const char* AliAnalysisTaskHFJets::GetHFEventRejectionReasonLabel(UInt_t& bitmap)
{
...
Int_t AliAnalysisTaskHFJets::PostDataFromAnalysisEngine(OutputHandler const* handler)
{
...
/// \return pointer to the new AliAnalysisTaskHFJets task
AliAnalysisTaskHFJets* AliAnalysisTaskHFJets::AddTaskHFJets(TString ntracks, TString nclusters, TString nMCpart, Int_t nMaxTrees, TString suffix)
{
    // Get the pointer to the existing analysis manager via the static access method
    AliAnalysisManager* mgr = AliAnalysisManager::GetAnalysisManager();
    if(!mgr) {
        ::Error("AddTaskHFJets", "No analysis manager to connect to.");
        return NULL;
    }
    ...
    if(!handler) {
        ::Error("AddTaskHFJets", "This task requires an input event handler");
        return NULL;
    }
    ...
    TString name("AliAnalysisTaskHFJets");
    if(strcmp(suffix, "") != 0) {
        name += TString::Format("_%s", suffix.Data());
    }
    
    AliAnalysisTaskHFJets* jetTask = new AliAnalysisTaskHFJets(name, nMaxTrees);
